...
\pgfsetcolor{black}
  % Edge: n1 -> n2
  \draw [->] (113bp,219bp) .. controls (104bp,210bp) and (93bp,218bp)  .. (76bp,190bp);
  % Edge: n1 -> n3
  \draw [->] (141bp,219bp) .. controls (150bp,210bp) and (161bp,218bp)  .. (178bp,190bp);
  % Edge: n4 -> n5
  \draw [->] (59bp,72bp) .. controls (59bp,64bp) and (59bp,65bp)  .. (59bp,46bp);
  % Edge: n6 -> n7
  \draw [->] (195bp,72bp) .. controls (195bp,64bp) and (195bp,65bp)  .. (195bp,46bp);
  % Edge: n2 -> n4
...
\begin{scope}
  ...
  \draw (59bp,162bp) node {$agt1: nil \atop agt2: (act1,res1)$};
\end{scope}
  % Node: n3
\begin{scope}
  \pgfsetstrokecolor{black}
  \draw (254bp,180bp) -- (136bp,180bp) -- (136bp,144bp) -- (254bp,144bp) -- cycle;
  \draw (195bp,162bp) node {$agt1: nil \atop agt2: (act1,res2)$};
\end{scope}
  % Node: n4
\begin{scope}
  \pgfsetstrokecolor{black}
...
\begin{scope}
  ...
  \draw (59bp,18bp) node {$agt1: nil \atop agt2: act2$};
\end{scope}
  % Node: n6
\begin{scope}
  \pgfsetstrokecolor{black}
...
\begin{scope}
  ...
  \draw (195bp,18bp) node {$agt1: act3 \atop agt2: act3$};
\end{scope}
%
\end{tikzpicture}
