...
\begin{thmext}
[{{[}{{[}{\ref{thm:Reg_Knows}}]}]}] Given a basic action theory
$\Dt\cup\Dt_{K}^{obs}$ and a uniform formula $\phi$:\[
...
\begin{thmext}
[{{[}{{[}{\ref{thm:Reg_PKnowsZ}}]}]}] For any epistemic path
$\pi$, uniform formula $\phi$ and action $c$:\begin{gather*}
...
\begin{thmext}
[{{[}{{[}{\ref{thm:En_impl_En-1}}]}]}] For any epistemic path
$\pi$: \[
...
\begin{lemmaext}
[{{[}{{[}{\ref{lem:Knows_impl_KnowsLbU}}]}]}] For any $agt$,
$\phi$ and $s$:\[
