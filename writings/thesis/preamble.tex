...
\usepackage[left=40mm,right=31mm,top=17mm,bottom=20mm,includeheadfoot,headheight=14pt]{geometry}
\usepackage{graphics}
\usepackage{graphicx}
...
\fancyfoot[LE]{\setlength{\fboxsep}{2mm}
     \fcolorbox{black}{lightgrey}{\vspace{-1mm}\rule{0mm}{3mm}\bfseries \thepage}}
