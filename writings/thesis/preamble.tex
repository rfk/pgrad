...
\documentclass[a4paper,british,twoside,11pt,draft]{book}
...
\newenvironment{proofsketch}{\begin{proof}[Proof Sketch]}{ For a detailed proof see Appendix \ref{ch:proofs}. \end{proof}}
