...
Let us re-iterate: paths are not terms in $\Lsit$,
...
and the use of $\UnZ$ lets the inductive hypothesis account
...
$c$ gives us the required $\Reg$ expression. Using $\UnZ$
...
\begin{defnL}
[{Embedding~FODL~into~Golog}] The embedding of FODL into epistemic
