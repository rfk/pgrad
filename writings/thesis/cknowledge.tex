...
}term, $\phi$ a uniform formula and $x$ a variable name, then the
...
\begin{defnL}
[{Epistemic~Path~Semantics}] \label{def:KDo}A
situation $s'$ is reachable from situation $s$ via epistemic path
$\pi$, denoted $\KDo(\pi,s,s')$, according to the following definitions.
