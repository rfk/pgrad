...
for this thesis, detailed proofs for those theorems where only
a proof sketch is provided in the main thesis body, and a full specification
of the \char`\"{}cooking agents\char`\"{} example domain. 
\end{itemize}
