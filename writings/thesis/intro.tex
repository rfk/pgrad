...
cook, she has built a team of robotic chefs to help her prepare
...
TODO: a bit more palaver here about why this is so great.
\newpage{}


\section{Scope}

Before presenting any further details of these contributions, it is
worth pausing to clarify the precise scope of our investigation. 
...
to to find some application or resonance beyond the specifics of the
situation calculus.\newpage{}
...
subsequent chapter. 
\item Chapter \ref{ch:mindigolog} introduces \emph{MIndiGolog}, a Golog variant
suitable for planning the cooperative execution
of a shared task\emph{.} We demonstrate an implementation using
distributed logic programming to share the
planning workload, and discuss why current situation calculus techniques 
limit it to synchronous domains. 
...
more detail. 
\item Appendix \ref{ch:proofs} provides the detailed proofs for those theorems where only a proof sketch is provided in the main thesis body.
\end{itemize}
