...
This chapter shows how these apparent limitations of the situation calculus
...
For the simple example shown in this chapter, parallel plan search does
...
This chapter considers only the offline construction of a joint execution.
