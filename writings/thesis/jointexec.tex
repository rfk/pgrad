...
Our implementation of a ConGolog execution planner utilises the Mozart
...
The agents must therefore synchronise their use of these resources.
...
a different ingredient and only synchronising on the availability
...
Capturing \emph{online} execution in an synchronous domain is less
...
The difficulty here is due to the well-known correspondence between
