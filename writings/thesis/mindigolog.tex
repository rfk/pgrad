...
This procedure can then be passed to the parallel search functionality
to plan a program execution. Here {}``jim'' and {}``joe'' are
the DNS names of agents in the team, and {}``Goloz'' is an Oz functor
that exports the \textbf{\emph{Do}} procedure defined above:
