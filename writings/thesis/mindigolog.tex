...
is that some limitations of the reasoning and planning machinery of
the situation calculus tend to restrict the multi-agent domains in
which it is applicable. This first incarnation of MIndiGolog has inherited
these limitations.
