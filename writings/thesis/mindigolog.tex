...
could be used to model and implement domains such as our example.
One popular choice is to represent tasks using a variant of the Hierarchical
Task Networks formalism, which has been employed in systems such as
STEAM \citep{tambe97flexible_teamwork}, SharedPlans \citep{grosz96sharedplans},
...
will add to list: the ability to utilise off-the-shelf techniques
...
The approach presented in this chapter is by no means a a complete
...
a task, without explicit notions of cooperation or commitment. However,
these techniques could easily form a component of a higher-level multi-agent
system based on the situation calculus, such as the CASL framework
\citep{shapiro02casl,lesperance05ecasl}.
