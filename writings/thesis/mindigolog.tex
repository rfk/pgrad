...
Language \citep{shapiro02casl} as well as earlier work in \citep{lesperance99modeling}.
In such a setting, the agents to not necessarily cooperate or coordinate
their actions, and it is assumed that \emph{any} legal execution of
the combined agent programs is a possible evolution of the entire
system.
...
is that limitations in the effective reasoning and planning machinery
of the situation calculus tend to restrict the multi-agent domains
to which it can be applied. This first incarnation of MIndiGolog has
inherited these limitations.
