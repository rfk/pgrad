...
reflecting the new semantics from equation TODO.  First, we introduce a
subsidiary procedure \emph{Step} which calculates a series of transitions
...
TODO: dept-first search generates highly concurrent programs.
...
execution algorithm (TODO: ref). The code for the control algorithm
is shown below:

\programinput{listings/mindigolog/goloz_control.oz}

This approach requires no communication
