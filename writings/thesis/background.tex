...
\noun{Situation}, and $x$ a variable that is not of sort \noun{Situation}.
...
terms not mentioning any term of sort \noun{Situation}, and $x$ an
arbitrary variable that is not of sort \noun{Situation}. Then the
...
\begin{defnL}
[{Regressable~Formulae}] The regressable formulae are the smallest
set of syntactically-valid formulae satisfying: (TODO: regressible
terms?)\[
