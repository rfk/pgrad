...
actions \citep{reiter96sc_nat_conc}, and we begin from the standard
account of knowledge due to \citep{scherl03sc_knowledge}. A brief
...
\begin{itemize}
\item Basic Golog, operators, semantics \citet{levesque97golog} 
...
\item ConGolog \citet{giacomo00congolog}. Also some discussion of related
semantics, such as CCS 
\item IndiGolog - highlight online/offline distinction and connections to
coordination and planning \citet{giacomo99indigolog} 
\item TConGolog - highlight deficiencies \citet{pinto99tcongolog} 
...
variable that is not of sort \noun{Situation}. Then the formulae uniform
...
\begin{itemize}
\item Knowledge, Distributed Knowledge, Common Knowledge \citet{halpern90knowledge_distrib,fagin95} 
\item Importance of Common Knowledge for Coordination 
\item Knowledge in the Situation Calculus

\begin{itemize}
\item Reasoning about Knowledge \citet{moore80know_act,scherl03sc_knowledge} 
\item Use in a multi-agent setting (??what's the best reference) 
\item Concurrency and time \citet{scherl03conc_knowledge} 
\item Shortcomings of multi-agent extensions 
\item Decidable fragments, weakening for computational efficiency 
\end{itemize}
\item Epistemic feasibility of plans: \citet{giacomo04sem_delib_indigolog,Lesperance01epi_feas_casl} 
\end{itemize}
