...
calculus. Reasoning about knowledge is covered in section \ref{sec:Background:Epistemic-Reasoning}.
...
\begin{defnL}
[{Objective~Uniform~Formulae}] Let $\sigma$ be a fixed
...
For functional fluents, $\Dt_{ssa}$ contains a similar axioms specifying
...
\noun{Concurrent} is added to $\mathcal{L}_{sitcalc}$, and the appropriate
...
TODO: not sure how much I really need to say here - revisit this section
...
Recent work in dynamic epistemic logic as overcome this limitation
by using a more expressive epistemic language. In the Logic of Communication
and Change or {}``LCC'' \citep{vanBenthem06lcc} use the syntax
of dynamic logic to formulate complex epistemic modalities, and derive
the equivalent of a regression rule for this language. We incorporate
this new technique into the situation calculus.
...
Not sure how much of this belongs here and how much in the individual
chapter.
...
Revisit after jointexec chapter to see if I really need this.
