\global\long\def\isdef{\stackrel{\mbox{\tiny def}}{=}}
 ...
 \global\long\global\long\def\Dt{\mathcal{D}}
 \global\long\global\long\def\Reg{\mathcal{R}}
 \global\long\global\long\def\Pst{\mathcal{P}}
 \global\long\global\long\def\Trn{\mathcal{T}}
 \global\long\global\long\def\Kln{\mathcal{K}}
 \global\long\global\long\def\TrnA{\Trn_{a}}
 \global\long\global\long\def\EKnows{\mathbf{EKnows}}
 \global\long\global\long\def\Knows{\mathbf{Knows}}
 \global\long\global\long\def\CKnows{\mathbf{CKnows}}
 \global\long\global\long\def\KnowsZ{\mathbf{Knows_{0}}}
 \global\long\global\long\def\PKnowsZ{\mathbf{PKnows_{0}}}
 \global\long\global\long\def\PKnows{\mathbf{PKnows}}
 \global\long\global\long\def\KDoZ{\mathbf{KDo_{0}}}
 \global\long\global\long\def\KDoC{\mathbf{KDo_{cps}}}
 \global\long\global\long\def\EDo{\mathbf{EDo}}
 \global\long\global\long\def\vars#1{\bar{#1}}
 \global\long\global\long\def\LbU{LbU}
 \global\long\global\long\def\LNTP{\mathbf{LNTP}}
 \global\long\global\long\def\PNA{\mathbf{PNA}}
 \global\long\global\long\def\Do{\mathbf{Do}}
 \global\long\global\long\def\PstD{\Pst_{\Dt}}
 \global\long\global\long\def\PstDI{\Pst_{\Dt}^{1}}
 \global\long\global\long\def\UnZ{\mathcal{Z}}
 \global\long\global\long\def\Lsit{\mathcal{L}_{sitcalc}}
 \global\long\global\long\global\long\def\Dt{\mathcal{D}}
 \global\long\global\long\global\long\def\Reg{\mathcal{R}}
 \global\long\global\long\global\long\def\Pst{\mathcal{P}}
 \global\long\global\long\global\long\def\Trn{\mathcal{T}}
 \global\long\global\long\global\long\def\Kln{\mathcal{K}}
 \global\long\global\long\global\long\def\TrnA{\Trn_{a}}
 \global\long\global\long\global\long\def\EKnows{\mathbf{EKnows}}
 \global\long\global\long\global\long\def\Knows{\mathbf{Knows}}
 \global\long\global\long\global\long\def\CKnows{\mathbf{CKnows}}
 \global\long\global\long\global\long\def\KnowsZ{\mathbf{Knows_{0}}}
 \global\long\global\long\global\long\def\PKnowsZ{\mathbf{PKnows_{0}}}
 \global\long\global\long\global\long\def\PKnows{\mathbf{PKnows}}
 \global\long\global\long\global\long\def\KDoZ{\mathbf{KDo_{0}}}
 \global\long\global\long\global\long\def\KDoC{\mathbf{KDo_{cps}}}
 \global\long\global\long\global\long\def\EDo{\mathbf{EDo}}
 \global\long\global\long\global\long\def\vars#1{\bar{#1}}
 \global\long\global\long\global\long\def\LbU{LbU}
 \global\long\global\long\global\long\def\LNTP{\mathbf{LNTP}}
 \global\long\global\long\global\long\def\PNA{\mathbf{PNA}}
 \global\long\global\long\global\long\def\Do{\mathbf{Do}}
 \global\long\global\long\global\long\def\PstD{\Pst_{\Dt}}
 \global\long\global\long\global\long\def\PstDI{\Pst_{\Dt}^{1}}
 \global\long\global\long\global\long\def\UnZ{\mathcal{Z}}
 \global\long\global\long\global\long\def\Lsit{\mathcal{L}_{sitcalc}}
...
\begin{defnL}
[{{[}{{[}{{[}{Uniform~Terms}{]}}{]}}{]}}] Let $\sigma$ be
a fixed situation term, $r$ an arbitrary rigid function symbol, $f$
an arbitrary fluent function symbol, and $x$ a variable that is not
of sort \noun{Situation}. Then the terms uniform in $\sigma$ are
the smallest set of syntactically-valid terms satisfying:\[
\tau\,::=x\,|\, r(\vars{\tau})\,|\, f(\vars{\tau},\sigma)\]

\begin{defnL}
[{{[}{{[}{{[}{Uniform~Formulae}{]}}{]}}{]}}] Let $\sigma$
be a fixed situation term, $R$ an arbitrary rigid predicate, $F$
an arbitrary primitive fluent predicate, $\tau$ an arbitrary term
uniform in $\sigma$, and $x$ an arbitrary variable that is not of
sort \noun{Situation}. Then the formulae uniform in $\sigma$ are
...
to this theory. 
\begin{defnL}
[{{[}{{[}{{[}{Basic~Action~Theory}{]}}{]}}{]}}] A basic action
theory, denoted $\Dt$, is a set of situation calculus sentences (of
the specific syntactic form outlined below) describing a particular
dynamic world. It consists of the following disjoint sets: the foundational
axioms of the situation calculus ($\Sigma$); action description axioms
defining preconditions etc for each action ($\Dt_{ad}$); successor
state axioms describing how primitive fluents change between situations
($\Dt_{ssa}$); axioms describing the value of primitive fluents in
the initial situation ($\Dt_{S_{0}}$); and axioms describing the
static background facts of the domain ($\Dt_{bg}$):\[
...
formulae}. 
\begin{defnL}
[{{[}{{[}{{[}{Regressable~Terms}{]}}{]}}{]}}] Let $\sigma$
be an arbitrary situation term, $x$ an arbitrary variable not of
sort situation, $r$ an arbitrary rigid function and $f$ an arbitrary
fluent function. Then the regressable terms are the smallest set of
syntactically-valid terms satisfying: \[
\nu::=\sigma\,|\, x\,|\, f(\vars{\nu},\sigma)\,|\, r(\vars{\nu})\]
...
of regressable formulae. 
\begin{defnL}
[{{[}{{[}{{[}{Regression~Operator}{]}}{]}}{]}}] Let $R$ be
a rigid predicate, $\alpha$ be an action description predicate with
axiom $\alpha(\vars{\nu},a,s)\equiv\Pi_{\alpha}(a,s)$ in $\Dt_{ad}$,
and $F$ be a primitive fluent with axiom $F(\vars x,s)\equiv\Phi_{F}(\vars x,s)$
...
\begin{defnL}
[{{[}{{[}{{[}{Empty~Action~Consistency}{]}}{]}}{]}}] A basic
action theory $\Dt$ using concurrent actions must entail the following
consistency requirements for the empty set of actions:\begin{gather*}
\Dt\,\models\,\forall s:\,\neg Legal(\{\},s)\\
