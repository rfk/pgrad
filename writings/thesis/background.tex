...
%
\begin{figure}
TODO: naive reverse listing

\caption{Naive list reverse implemented in Mozart }
...
classic prolog example, the color combination selector, which is implemented
in Mozart in figure {[}TODO].
