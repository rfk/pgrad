...
\begin{defnL}
[{Basic~Action~Theory}] A basic action theory, denoted $\Dt$,
is a set of situation calculus sentences (of the specific syntactic
form outlined below) describing a particular dynamic world. It consists
...
\begin{defnL}
[{Objective~Uniform~Formulae}] Let $s$ be a fixed situation term,
$F$ an arbitrary fluent, $\vars{x}$ a vector of terms mentioning
