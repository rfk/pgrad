...
are briefly discussed in section \ref{sec:Background:Related-Formalisms}. Finally, section \ref{sec:Background:Mozart/Oz}
...
\section{Related Formalisms}\label{sec:Background:Related-Formalisms}
...
situation calculus in this paper.
