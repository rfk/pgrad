...
calculus, as it allows one to anser the \emph{projection problem}.
...
rest of the thesis. To avoid unintuitive behaviour, we assume that
the domain entails the following consistency requirements for the
...
regression as an effective reasoning technique.
...
\end{defnL}
The definition of regressable formulae is updated in a similar way.
