...
The language $\Lsit$ of the situation calculus is
...
$\Lsit$ contains the standard alphabet of logical
...
from $\Lsit$ called a \emph{basic action theory}.
...
The additional sort \noun{Concurrent} is added to $\Lsit$,
...
\citep{pinto94temporal,pinto95reasoning_time,reiter96sc_nat_conc}. An additional sort \noun{Timepoint}
...
That is, each agent's knowledge is updated to accont for each action
