...
\label{alg:golog_exec}
\begin{algorithmic}
\STATE Find a situation $s$ such that: $\Dt \cup \Dt_{golog} \models \exists \delta':\ \left[Trans^*(\delta,S_0,\delta',s) \wedge Final(\delta',s)\right]$
\FOR{each action in the resulting situation term}
