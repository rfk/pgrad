...
of some formula $\phi$ when the guard condition $\psi$
is true would require the following to be entailed by the definition:\begin{gather*}
...
axiom for reasoning about knowledge. This makes our formalism significantly
...
will play an important role for effective reasoning
for our formalism.
