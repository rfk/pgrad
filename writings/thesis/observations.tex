...
Obs(agt,c,s)\neq\{\}\,\rightarrow & \, View(agt,do(c,s))=View(agt,s)\cdot Obs(agt,c,s)\label{eq:view_defn}\end{align}
...
secifying the $Obs$ function must ensure that agents do not perceive
