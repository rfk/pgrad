...
\typeout{IJCAI-07 Instructions for Authors}

% This is the instructions for authors for IJCAI-07.
% They are the same as the ones for IJCAI-05.

\documentclass{article}
% The file ijcai07.sty is the style file for IJCAI-07 (same as ijcai05.sty).
\usepackage{ijcai07}
...
\title{IJCAI--07 Formatting Instructions \\
(Same as the IJCAI--05 Formatting Instructions)\thanks{The support of IJCAI, Inc. is acknowledged.}}
...
\begin{abstract}
  The {\it IJCAI--07 Proceedings} will be printed from electronic
...
\noindent{\bf Full Papers:} Each accepted full paper is allowed six
pages in the proceedings. Up to two additional pages may be purchased
at a price of \$250 per page.

\vspace{0.2pt}

\noindent{\bf Poster Papers:} Each accepted poster paper is allowed
two pages in the proceedings. One additional page may be purchased at
a price of \$250 per page.
...
uniformity, Adobe's {\em Times Roman} font is strongly suggested. In
...
format for references, such as provided by Bib\TeX{}. The reference
...
The \LaTeX{} and Word style files are available on the IJCAI--07
website, {\tt http://www.ijcai-07.org/}.
These style files implement the formatting instructions in this
document.

The \LaTeX{} files are {\tt ijcai07.sty} and {\tt ijcai07.tex}, and
the Bib\TeX{} files are {\tt named.bst} and {\tt ijcai07.bib}. The
\LaTeX{} style file is for version 2e of \LaTeX{}, and the Bib\TeX{}
style file is for version 0.99c of Bib\TeX{} ({\em not} version
0.98i). The {\tt ijcai07.sty} file is the same as the {\tt
ijcai05.sty} file used for IJCAI--05.

The Microsoft Word style file consists of a single template file, {\tt
ijcai07.dot}. This template is the same as the one used for
IJCAI--05.

These Microsoft Word and \LaTeX{} files contain the source of the
present document and may serve as a formatting sample.  Note that the
required document layout is the same as for IJCAI'05.

Further information on using these styles for the preparation of
papers for IJCAI--07 can be obtained by contacting {\tt
pcchair07@ijcai.org}.

\bibliography{ijcai07}
