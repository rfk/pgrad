...
Introduces programming to the SitCalc via "complex actions".
...
\end{itemize}
\pause
Adding time to the SitCalc has a long history [TODO].
...
\begin{frame}
\frametitle{The Concurrent Situation Calculus [TODO]}
...
\begin{frame}
\frametitle{Natural Actions [TODO]}
...
\end{itemize}
\ \\
Golog has been sucessfully used in the RoboCup simulation leage [TODO].
\end{frame}
